...
exception (see \S \ref{sec:internal_run_time_exceptions}).
...
An \textbf{\emph{expression statement}} is either an individual assignment or a function call. All side-effects of a given
expression are completed before the next expression is executed.
