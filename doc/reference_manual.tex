...
The word \textbf{\emph{constant}} has two different meanings in Hog. It can refer to either a variable that is \emph{constant},
...
\begin{itemize}
  \item[] \tt -1\rm, \tt 0\rm, \tt 1\rm, \tt 2\rm (all of type \tt int\rm)
\end{itemize}

In addition, there are also constants associated with each type:
   int (i.e. -1, 0, 1, 2, 3)
   real (i.e. -0.12, 6.79, 140.4)
   bool (true, false)
   text (i.e. ``hello world'', ``programming'')
