...
logically meaningful sequences, and for each lexeme the lexlical analyser sends to
...
tree-like intermediate representation of the source program, which depics the
