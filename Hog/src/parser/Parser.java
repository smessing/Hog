...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Mar 29 17:03:18 EDT 2012
  */
  ...
  public final java_cup.runtime.Symbol CUP$Parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      RESULT = expr;
		...
		Integer factor = (Integer)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
      ...
      RESULT = factor;
		...
		Integer term = (Integer)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		int factorleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).left;
		int factorright = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		Integer factor = (Integer)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
      ...
      RESULT = new Integer( term.intValue() * factor.intValue() );
		...
		Integer term = (Integer)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
     ...
     RESULT = term;
      ...
      RESULT = new Integer( - term.intValue() );
		...
		Integer expr = (Integer)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		int termleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).left;
		int termright = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		Integer term = (Integer)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
